...
\section*{\faTags\ List commands}

\begin{geolbox}
\begin{geolitemize}
  \item \cmd{geol help list} help about the \cmd{list} command
...
\section*{\faEye\ Stack survey}
\begin{geolbox}
\begin{geolitemize}
  \item \cmd{geol help check}: Get help about the \cmd{check} command
  \item \cmd{geol init}: Create a valid \cmd{.geol.yaml} check file
