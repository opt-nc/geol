...
\pagestyle{fancy}
\fancyhf{}
% Keep document minimal: no running chapter titles in the header to
% avoid duplication with chapter titles (page number only in footer).
\fancyfoot[C]{\thepage}
...
% Use French heading for bibliography produced by thebibliography
...
\appendix
% Use an unnumbered appendix chapter but keep it in the TOC to avoid
% potential duplicate printed headings from the document class.
\chapter*{Annexe A}
